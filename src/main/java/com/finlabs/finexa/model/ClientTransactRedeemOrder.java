...
/**
 * The persistent class for the clientTransactRedeemOrder database table.
 * 
 */
@Entity
@Table(name="clientTransactRedeemOrder")
@NamedQuery(name="ClientTransactRedeemOrder.findAll", query="SELECT c FROM ClientTransactRedeemOrder c")
public class ClientTransactRedeemOrder implements Serializable {
	...
	public ClientTransactRedeemOrder() {
	}
