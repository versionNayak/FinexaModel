...
/**
 * The persistent class for the masterSCSSInterestRate database table.
 * 
 */
@Entity
@Table(name = "masterSCSSInterestRate")
@NamedQuery(name = "MasterSCSSInterestRate.findAll", query = "SELECT m FROM MasterSCSSInterestRate m")
public class MasterSCSSInterestRate implements Serializable {
