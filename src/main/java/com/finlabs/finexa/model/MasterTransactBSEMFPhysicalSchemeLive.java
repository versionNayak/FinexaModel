...
/**
 * The persistent class for the masterTransactBSEMFPhysicalSchemeLive database table.
 * 
 */
@Entity
@Table(name="masterTransactBSEMFPhysicalSchemeLive")
@NamedQuery(name="MasterTransactBSEMFPhysicalSchemeLive.findAll", query="SELECT m FROM MasterTransactBSEMFPhysicalSchemeLive m")
public class MasterTransactBSEMFPhysicalSchemeLive implements Serializable {
	...
	public MasterTransactBSEMFPhysicalSchemeLive() {
	}
