...
/**
 * The persistent class for the masterTransactDivPayMode database table.
 * 
 */
@Entity
@Table(name="masterTransactDivPayMode")
@NamedQuery(name="MasterTransactDivPayMode.findAll", query="SELECT m FROM MasterTransactDivPayMode m")
public class MasterTransactDivPayMode implements Serializable {
	...
	@OneToMany(mappedBy="masterTransactDivPayMode")
	private List<ClientUCCDetail> clientUccdetails;

	public MasterTransactDivPayMode() {
	}
	...
	public ClientUCCDetail addClientUccdetail(ClientUCCDetail clientUccdetail) {
		...
		clientUccdetail.setMasterTransactDivPayMode(this);
	...
	public ClientUCCDetail removeClientUccdetail(ClientUCCDetail clientUccdetail) {
		...
		clientUccdetail.setMasterTransactDivPayMode(null);
