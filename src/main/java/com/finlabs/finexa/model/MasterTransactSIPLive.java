...
/**
 * The persistent class for the masterTransactSIPLive database table.
 * 
 */
@Entity
@Table(name="masterTransactSIPLive")
@NamedQuery(name="MasterTransactSIPLive.findAll", query="SELECT m FROM MasterTransactSIPLive m")
public class MasterTransactSIPLive implements Serializable {
